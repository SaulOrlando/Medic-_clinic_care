        ...
        http
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/login").permitAll()
                 .requestMatchers("/categorias-medicamentos/**").hasAnyRole("ADMINISTRADOR", "RECEPCIONISTA", "MEDICO")
                 .requestMatchers("/medicamentos/**").hasAnyRole("ADMINISTRADOR", "RECEPCIONISTA", "MEDICO")
                ...
                .requestMatchers("/pacientes", "/pacientes/**").hasAnyRole("ADMINISTRADOR", "MEDICO", "RECEPCIONISTA")
                .requestMatchers("/configuracion", "/configuracion/**").hasAnyRole("ADMINISTRADOR", "MEDICO", "RECEPCIONISTA")
